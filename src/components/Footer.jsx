...
export default function Footer() {
  ...
  <div class="w-full px-8 mx-auto max-w-7xl m-5">
    <div class="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
      <h5 class=" brandname block mb-6 font-sans text-4xl antialiased font-semibold leading-snug tracking-normal text-inherit">
Vivid   </h5>
      <div class="grid justify-between grid-cols-3 gap-4">
        ...
        <ul>
          ...
          <li>
          <Link to="/contact" className="block py-1.5 font-sans text-base font-normal leading-relaxed text-gray-700 antialiased transition-colors hover:text-blue-gray-900">Contact Us</Link>
          </li>
